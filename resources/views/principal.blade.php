...
<header class="app-header navbar">
        ...
        <ul class="nav navbar-nav d-md-down-none">
            <li class="nav-item px-3">
                <a class="nav-link" href="#">Coope Guayacán</a>
            </li>
    ...
    <footer class="app-footer">
        <span><a>COOPERATIVA GUAYACÁN</a> &copy; 2020</span>
        <span class="ml-auto">Desarrollado por <a href="http://www.webtraining-it.com/">Axel Morales</a></span>
    </footer>
